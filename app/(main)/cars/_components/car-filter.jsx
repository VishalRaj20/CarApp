...
import CarFilterControls from './car-filter-control';
...
const CarFilters = ({ filters }) => {
    ...
    //Get current filter vlaues from searchParams 
    ...
    }, [currentBodyType, currentFuelType, currentMake, currentMaxPrice, currentMinPrice, currentSortBy, currentTransmission])
    ...
    if (filterName === "priceRange") {
        handleFilterChange(filterName, [filters.priceRange.min, filters.priceRange.max]);
    } else {
        handleFilterChange(filterName, "");
    }
    };
                            ...
                            <SheetHeader>
                                ...
                                <SheetFooter className="sm:justify-between flex-row pt-2 border-t space-x-4 mt-auto">
                                    ...
                                    <Button
                                        ...
                                        className="flex-1" >Show Results</Button>
                                </SheetFooter>
                            </SheetHeader>
                        </SheetContent>
                    </Sheet>
