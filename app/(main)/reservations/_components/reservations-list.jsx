    ...
    if (initialData?.data?.length === 0) {
        return (
            <div className='min-h-[400px] flex flex-col items-center justify-center text-center p-8 border rounded-lg bg-gray-50'>
                ...
                <p className='text-gray-500 mb-6 max-w-md'>You don't have any test drive reservations yet. Browse our cars and book a test drive to get started.</p>
        ...
        <div className='space-y-6'>
            <div >
                ...
                {upcomingBookings.length === 0 ? (
                    <p className='text-gray-500 italic pb-4'>No upcoming test drives.</p>
                ) : (
                    <div>
